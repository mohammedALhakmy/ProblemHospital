...
export default defineConfig({
    plugins: [
        ...
        viteStaticCopy({
            targets: [
                {
                    src: (['resources/assets/img/', 'resources/assets/plugins/',
                     'resources/assets/js/jquery.vmap.sampledata.js', 'resources/assets/js/sticky.js',
                      'resources/assets/iconfonts/', 'resources/assets/landing/']),
                    dest: 'assets/'
                }
            ]
        }),
