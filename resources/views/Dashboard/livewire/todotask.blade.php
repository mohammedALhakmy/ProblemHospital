                                            ...
                                            <div class="todo-widget-header d-flex pb-2 pd-20">
                                                <div class="dropdown">
                                                    <div class="drop-down-profile" data-bs-toggle="dropdown"><img alt=""
                                                            ...
                                                            src="{{asset('build/assets/img/users/1.jpg')}}"><span
                                        ...
                                        <div class="card-body p-0">
                                            <div class="todo-widget-header d-flex pb-2 pd-20">
                                                <div class="dropdown">
                                                    <div class="drop-down-profile" data-bs-toggle="dropdown"><img alt=""
                                                            class="rounded-circle avatar avatar-md "
                                                            src="{{asset('build/assets/img/users/12.jpg')}}"><span
                                        ...
                                        <div class="card-body p-0">
                                            <div class="todo-widget-header d-flex pb-2 pd-20">
                                                <div class="dropdown">
                                                    <div class="drop-down-profile" data-bs-toggle="dropdown"><img alt=""
                                                            class="rounded-circle avatar avatar-md "
                                                            src="{{asset('build/assets/img/users/9.jpg')}}"><span
                                        ...
                                        <div class="card-body p-0">
                                            <div class="todo-widget-header d-flex pb-2 pd-20">
                                                <div class="dropdown">
                                                    <div class="drop-down-profile" data-bs-toggle="dropdown"><img alt=""
                                                            class="rounded-circle avatar avatar-md "
                                                            src="{{asset('build/assets/img/users/4.jpg')}}"><span
                                        ...
                                        <div class="card-body p-0">
                                            <div class="todo-widget-header d-flex pb-2 pd-20">
                                                <div class="dropdown">
                                                    <div class=" drop-down-profile" data-bs-toggle="dropdown"><img alt=""
                                                            class="rounded-circle avatar avatar-md"
                                                            src="{{asset('build/assets/img/users/15.jpg')}}"><span
                                        ...
                                        <div class="card-body p-0">
                                            <div class="todo-widget-header d-flex pb-2 pd-20">
                                                <div class="dropdown">
                                                    <div class="drop-down-profile" data-bs-toggle="dropdown"><img alt=""
                                                            class="rounded-circle avatar avatar-md "
                                                            src="{{asset('build/assets/img/users/5.jpg')}}"><span
                            ...
                            <div class="card">
                                <div class="card-body p-0">
                                    ...
                                    <div class="d-flex p-3 border-top">
                                        <label class="ckbox"><input class="mb-2" checked="" type="checkbox"><span>Do something
                                                more</span></label>
                                        <span class="ms-auto">
                                    ...
                                    <div class="d-flex p-3 border-top">
                                        <label class="ckbox"><input class="mb-2" checked="" type="checkbox"><span>Update More
                                                Files</span></label>
                                        <span class="ms-auto">
                                            <i class="si si-pencil text-primary me-2" data-bs-toggle="tooltip" title=""
                                                data-bs-placement="top" data-bs-original-title="Edit"></i>
                                    ...
                                    <div class="d-flex p-3 border-top">
                                        <label class="ckbox"><input class="mb-2" type="checkbox"><span>Complete Projects</span></label>
                                        <span class="ms-auto">
                                            <i class="si si-pencil text-primary me-2" data-bs-toggle="tooltip" title=""
                                                data-bs-placement="top" data-bs-original-title="Edit"></i>
                                            <i class="si si-trash text-danger me-2" data-bs-toggle="tooltip" title=""
                                    ...
                                    <div class="d-flex p-3 border-top">
                                        <label class="ckbox"><input class="mb-2" type="checkbox"><span>Finish Something</span></label>
                                        <span class="ms-auto">
                                            <i class="si si-pencil text-primary me-2" data-bs-toggle="tooltip" title=""
                                                data-bs-placement="top" data-bs-original-title="Edit"></i>
                                            <i class="si si-trash text-danger me-2" data-bs-toggle="tooltip" title=""
                                    ...
                                    <div class="d-flex p-3 border-top">
                                        <label class="ckbox"><input class="mb-2" type="checkbox"><span>Change Settings</span></label>
                                        <span class="ms-auto">
                                            <i class="si si-pencil text-primary me-2" data-bs-toggle="tooltip" title=""
                                                data-bs-placement="top" data-bs-original-title="Edit"></i>
                                            <i class="si si-trash text-danger me-2" data-bs-toggle="tooltip" title=""
