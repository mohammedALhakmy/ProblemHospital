                                    ...
                                    <div class="ps-0">
                                        <div class="main-profile-overview">
                                            <div class="main-img-user profile-user">
                                                <img alt="" src="{{asset('build/assets/img/users/6.jpg')}}"><a
                                            ...
                                            <div class="main-profile-social-list">
                                                ...
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <span>Twitter</span> <a href="javascript:void(0);">twitter.com/spruko.me</a>
                                                    </div>
                                                </div>
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <span>Linkedin</span> <a href="javascript:void(0);">linkedin.com/in/spruko</a>
                                                    </div>
                                                </div>
                                                <div class="media">
...
@section('scripts')
        ...
        @vite('resources/assets/js/gallery-1.js')
