                        ...
                        <div class="d-flex my-xl-auto right-content align-items-center">
                            ...
                            <div class="mb-xl-0">
                                <div class="btn-group dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuDate">
							...
							<div class="card custom-card">
								<div class="card-body">
									<div class="col-lg-12 col-sm-12 mb-2">
										<h6 class="main-content-label  mb-2 ">Font Awesome</h6>
										<p class="mb-2">Powered by Font Awesome set. For more info <a href="http://fontawesome.io" target="_blank" class="text-primary">click here</a>.</p>
