...
@section('content')
                    ...
                    <div class="row">
                            ...
                            <div class="card border-card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-xl-3 col-md-4 ">
                                            <div class="p-3 p-3 bg-gray-100 bd bd-5 mt-3">.border</div>
                                        </div>
                                    </div>
                                    <div class="table-responsive mg-t-25">
                                        <table class="table main-table-reference text-nowrap mg-b-0 mg-t-10">
                        ...
                        <!--/div-->
                        <div class="col-md-12 col-xl-12 col-xs-12 col-sm-12">
                            <div class="card mg-b-20 border-card">
                                <div class="card-body">
                                    <div class="main-content-label mg-b-5">
                                        Remove Border
                                    </div>
                            ...
                            <div class="card border-card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex flex-wrap">
                                        <div class="wd-80 ht-80 bd bd-gray-500 rounded my-1"></div>
                                        <div class="wd-80 ht-80 mg-l-10 bd bd-gray-500 rounded-5 my-1"></div>
                                        <div class="wd-80 ht-80 mg-l-10 bd bd-gray-500 rounded-10 my-1"></div>
                                        <div class="wd-80 ht-80 mg-l-10 bd bd-gray-500 rounded-20 my-1"></div>
                                        <div class="wd-80 ht-80 mg-l-10 bd bd-gray-500 rounded-30 my-1"></div>
                                        <div class="wd-80 ht-80 mg-l-10 bd bd-gray-500 rounded-circle my-1"></div>
                                    </div>
                                    <div class="table-responsive mg-t-20 mb-0">
                                        <table class="table main-table-reference text-nowrap mg-b-0 mg-t-0">
                                            <tbody>
