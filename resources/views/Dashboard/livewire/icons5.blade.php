						...
						<div class="col-md-12">
							...
							<div class="card-body">
								<div class="col-lg-12 col-sm-12 ">
									<h6 class="main-content-label">Ionic Icons</h6>
									<p class="mb-2">Simply beautiful open source icons. For more info <a href="https://ionicons.com" target="_blank" class="text-primary">click here</a>.</p>
