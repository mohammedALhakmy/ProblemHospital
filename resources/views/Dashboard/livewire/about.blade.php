                    ...
                    <div class="container">
						<div class="row about-main mb-5">
							<div class="col-lg-8 col-md-8 col-sm-12 text-center">
								<h1 class="mb-3 font-weight-semibold tx-46">Hello! This is <span class="text-primary tx-56">Valex.</span></h1>
						...
						<div class="row mb-5 rounded-5">
							<p><img src="{{asset('build/assets/img/photos/21.jpg')}}" class="rounded-5"  alt="image"></p>
						</div>
											...
											<div class="row">
												...
												<div class="col-xl-6">
													<div class="text-center">
														<img src="{{asset('build/assets/img/pngs/10.png')}}" alt="">
													</div>
												</div>
											</div>
										</div>
