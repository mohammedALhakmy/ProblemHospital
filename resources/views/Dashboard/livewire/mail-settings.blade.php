									...
									<form class="form-horizontal">
										...
										<div class="form-group ">
											<div class="row">
												...
												<div class="col-md-9">
													<a class="mg-r-20 d-inline-block" href="javascript:void(0);">Deactivate Account</a>
								...
								<div class="main-container container-fluid">
									<div class="main-mail-compose-box">
										<div class="main-mail-compose-header">
											...
											<nav class="nav">
												<a class="nav-link" href="javascript:void(0);"><i class="fas fa-minus"></i></a>
												<a class="nav-link" href="javascript:void(0);"><i class="fas fa-compress"></i></a>
												<a class="nav-link" href="javascript:void(0);"><i class="fas fa-times"></i></a>
											</nav>
										</div>
										<div class="main-mail-compose-body p-0">
											...
											<div class="form-group pd-10 mb-0">
												<nav class="nav">
													<a class="nav-link" data-bs-toggle="tooltip" href="javascript:void(0);" title="Add attachment"><i class="fas fa-paperclip"></i></a> <a class="nav-link" data-bs-toggle="tooltip" href="javascript:void(0);" title="Add photo"><i class="far fa-image"></i></a> <a class="nav-link" data-bs-toggle="tooltip" href="javascript:void(0);" title="Add link"><i class="fas fa-link"></i></a> <a class="nav-link" data-bs-toggle="tooltip" href="javascript:void(0);" title="Emoticons"><i class="far fa-smile"></i></a> <a class="nav-link" data-bs-toggle="tooltip" href="javascript:void(0);" title="Discard"><i class="far fa-trash-alt"></i></a>
