                    ...
                    <div class="row">
                            ...
                            <div class="card card-img-holder">
                                <div class="card-body list-icons p-0">
                                    ...
                                    <div class="card-footer p-0">
                                        <p class="text-muted mb-0 px-4 p-3"><i
                        ...
                        <div class="col-sm-12 col-lg-6 col-xl-3">
                            <div class="card card-img-holder">
                                <div class="card-body list-icons p-0">
                                    ...
                                    <div class="card-footer p-0">
                                        <p class="text-muted mb-0 px-4 p-3"><i class="si si-exclamation text-info me-2"></i>From
                                            Last Month</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-12 col-lg-6 col-xl-3">
                            <div class="card card-img-holder">
                                <div class="card-body list-icons p-0">
                                    ...
                                    <div class="card-footer p-0">
                                        <p class="text-muted mb-0 px-4 p-3"><i class="si si-check me-1 text-primary me-2"></i>
                                            Recent History</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-12 col-xl-4 col-lg-12">
                            <div class="card user-wideget user-wideget-widget widget-user">
                                ...
                                <div class="widget-user-image">
                                    <img src="{{asset('build/assets/img/users/17.jpg')}}" class="brround" alt="User Avatar">
                                </div>
                        ...
                        <div class="col-sm-12 col-xl-4 col-lg-12">
                            <div class="card user-wideget user-wideget-widget widget-user">
                                ...
                                <div class="widget-user-image">
                                    <img src="{{asset('build/assets/img/users/12.jpg')}}" class="brround" alt="User Avatar">
                                </div>
                                <div class="user-wideget-footer">
                                    <div class="row">
                                        <div class="col-sm-4 border-end">
                        ...
                        <div class="col-sm-12 col-xl-4 col-lg-12">
                            <div class="card user-wideget user-wideget-widget widget-user">
                                ...
                                <div class="widget-user-image">
                                    <img src="{{asset('build/assets/img/users/5.jpg')}}" class="brround" alt="User Avatar">
                                </div>
                                <div class="user-wideget-footer">
                                    <div class="row">
                                        <div class="col-sm-4 border-end">
                            ...
                            <div class="card">
                                <div class="card-header pb-0">
                                    ...
                                    <p class="tx-12 tx-gray-500 mb-3">On the other hand, we denounce with right indignation
                                        and dislike imagesralized <a href="javascript:void(0);">Learn more</a></p>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                    ...
                                    <div class="d-flex mb-0">
                                        <div class="">
                                            <h4 class="mb-1 fw-bold">5m 24s<span
                                                    class="text-success tx-13 ms-2 d-inline-block">(+19.5%)</span></h4>
                                            <p class="mb-2 tx-12 text-muted">Overview of Last month</p>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <div class="h3 mt-2 mb-2"><b>19.89K</b><span
                                                    class="text-success tx-13 ms-2 d-inline-block">(+25%)</span></div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <div class="h3 mt-2 mb-2"><b>$2.98M</b><span
                                                    class="text-success tx-13 ms-2 d-inline-block">(+35%)</span></div>
                                        </div>
                                        <div class="col-auto align-self-center ">
                                            <div class="feature mt-0 mb-0">
                                                <i
                                ...
                                <div class="card-body p-0">
                                    ...
                                    <div class="list d-flex align-items-center border-bottom p-3">
                                        <div class="avatar brround d-block cover-image"
                                            data-bs-image-src="{{asset('build/assets/img/users/5.jpg')}}">
                                            <span class="avatar-status bg-green"></span>
                                        </div>
                                        <div class="wrapper w-100 ms-3 m-0 p-0">
                                            <p class="mb-0">
                                    ...
                                    <div class="list d-flex align-items-center border-bottom p-3">
                                        <div class="avatar brround d-block cover-image"
                                            data-bs-image-src="{{asset('build/assets/img/users/1.jpg')}}">
                                            <span class="avatar-status bg-green"></span>
                                        </div>
                                        <div class="wrapper w-100 ms-3 m-0 p-0">
                                            <p class="mb-0">
                                    ...
                                    <div class="list d-flex align-items-center border-bottom p-3">
                                        <div class="avatar brround d-block cover-image"
                                            data-bs-image-src="{{asset('build/assets/img/users/14.jpg')}}">
                                            <span class="avatar-status bg-green"></span>
                                        </div>
                                        <div class="wrapper w-100 ms-3 m-0 p-0">
                                            <p class="mb-0">
                                    ...
                                    <div class="list d-flex align-items-center p-3">
                                        <div class="avatar brround d-block cover-image"
                                            data-bs-image-src="{{asset('build/assets/img/users/4.jpg')}}">
                                            <span class="avatar-status bg-green"></span>
                                        </div>
                                        <div class="wrapper w-100 ms-3 m-0 p-0">
                                            <p class="mb-0">
                                    ...
                                    <div>
                                        <div class="chips">
                                            <div class="team">
                                                <a href="javascript:void(0);" class="chip">
                                                    <span class="avatar cover-image"
                                                        data-bs-image-src="{{asset('build/assets/img/users/2.jpg')}}"></span> Victoria
                                                </a>
                                            ...
                                            <div class="team">
                                                <a href="javascript:void(0);" class="chip">
                                                    <span class="avatar cover-image"
                                                        data-bs-image-src="{{asset('build/assets/img/users/3.jpg')}}"></span> Nathan
                                                </a>
                                                <i class="fab fa-facebook text-primary" aria-hidden="true"></i>
                                                <i class="fab fa-twitter text-primary" aria-hidden="true"></i>
                                                <i class="fas fa-envelope text-primary" aria-hidden="true"></i>
                                            ...
                                            <div class="team">
                                                <a href="javascript:void(0);" class="chip">
                                                    <span class="avatar cover-image"
                                                        data-bs-image-src="{{asset('build/assets/img/users/4.jpg')}}"></span> Alice
                                                </a>
                                                <i class="fab fa-facebook text-primary" aria-hidden="true"></i>
                                                <i class="fab fa-twitter text-primary" aria-hidden="true"></i>
                                                <i class="fas fa-envelope text-primary" aria-hidden="true"></i>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body p-0">
                                    <table class="table card-table country-table mb-0">
                                        <tbody>
                                            <tr>
                                                <td class="w-1"><img src="{{asset('build/assets/img/flag-imgs/us_flag.jpg')}}" alt="flags"
                                                        class="flag wd-30 ht-20 flag-us mt-1"></td>
                                                <td>USA
                                            ...
                                            <tr>
                                                <td class="w-1"><img src="{{asset('build/assets/img/flag-imgs/spain_flag.jpg')}}" alt="flags"
                                                        class="flag wd-30 ht-20 flag-us mt-1"></td>
                                                <td>Spain
                                                    <div class="progress progress-sm mt-1">
                                            ...
                                            <tr>
                                                <td class="w-1"><img src="{{asset('build/assets/img/flag-imgs/germany_flag.jpg')}}"
                                                        alt="flags" class="flag wd-30 ht-20 flag-us mt-1"></td>
                                                <td>Germany
                                                    <div class="progress progress-sm mt-1">
                                            ...
                                            <tr>
                                                <td class="w-1"><img src="{{asset('build/assets/img/flag-imgs/russia_flag.jpg')}}"
                                                        alt="flags" class="flag wd-30 ht-20 flag-us mt-1"></td>
                                                <td>Russia
                                                    <div class="progress progress-sm mt-1">
                                            ...
                                            <tr>
                                                <td class="w-1"><img src="{{asset('build/assets/img/flag-imgs/italy_flag.jpg')}}" alt="flags"
                                                        class="flag wd-30 ht-20 flag-us mt-1"></td>
                                                <td>Italy
                                                    <div class="progress progress-sm mt-1">
                                            ...
                                            <tr>
                                                <td class="w-1"><img src="{{asset('build/assets/img/flag-imgs/french_flag.jpg')}}"
                                                        alt="flags" class="flag wd-30 ht-20 flag-us mt-1"></td>
                                                <td>French
                                                    <div class="progress progress-sm mt-1">
                                                        <div class="progress-bar bg-teal wd-40"></div>
                    ...
                    <div class="row row-sm">
                            ...
                            <div class="card">
                                <div class="card-header bg-transparent pd-b-0 pd-t-20 bd-b-0">
                                    ...
                                    <p class="tx-12 tx-gray-500 mb-0">Opinion of a customer on the product in the form of
                                        ratings 5-star rating. <a href="javascript:void(0);">Learn more</a></p>
                                </div><!-- card-header -->
                                <div class="card-body pd-y-7">
                                    ...
                                    <div class="wrapper d-flex justify-content-center image-group pb-3">
                                        <img src="{{asset('build/assets/img/users/1.jpg')}}" alt="profile" class="img-xs rounded-circle">
                                        <img src="{{asset('build/assets/img/users/2.jpg')}}" alt="profile" class="img-xs rounded-circle">
                                        <img src="{{asset('build/assets/img/users/13.jpg')}}" alt="profile"
                                            class="img-xs rounded-circle">
                                        <img src="{{asset('build/assets/img/users/14.jpg')}}" alt="profile"
                                            class="img-xs rounded-circle">
                                        <img src="{{asset('build/assets/img/users/5.jpg')}}" alt="profile" class="img-xs rounded-circle">
                                        <img src="{{asset('build/assets/img/users/16.jpg')}}" alt="profile"
                                            class="img-xs rounded-circle">
                                    </div>
                                </div><!-- card-body -->
                            </div>
                            ...
                            <div class="card order-list">
                                <div class="card-body">
                                    ...
                                    <p class="tx-12 tx-gray-500 mb-3">Order Activity is ecommerce platforms to track the
                                        orders placed on their stores <a href="javascript:void(0);">Learn more</a></p>
                                    <ul class="list list-noborders pb-0 mb-0">
                                        <li class="list-item">
                                            <img class="img-sm rounded-circle bg-warning d-flex align-items-center justify-content-center text-white"
                                                src="{{asset('build/assets/img/users/3.jpg')}}" alt="Profile Image">
                                            <div class=" ms-3">
                                                <h6 class="mb-1 fw-medium">Lottie Arnold</h6>
                                                <p class="mb-0 text-muted tx-13">#PRD-10250</p>
                                            </div>
                                            <div class="ms-auto d-flex">
                                                <img class="img-sm me-1" src="{{asset('build/assets/img/ecommerce/03.jpg')}}"
                                                    alt="thumb images">
                                                <img class="img-sm" src="{{asset('build/assets/img/ecommerce/08.jpg')}}"
                                                    alt="thumb images">
                                            </div>
                                        </li>
                                        <li class="list-item">
                                            <img class="img-sm rounded-circle bg-warning d-flex align-items-center justify-content-center text-white"
                                                src="{{asset('build/assets/img/users/9.jpg')}}" alt="Profile Image">
                                            <div class=" ms-3">
                                                <h6 class="mb-1 fw-medium">Alan Macedo</h6>
                                                <p class="mb-0 tx-13 text-muted">#PRD-10251</p>
                                            </div>
                                            <div class="ms-auto d-flex">
                                                <img class="img-sm me-1" src="{{asset('build/assets/img/ecommerce/04.jpg')}}"
                                                    alt="thumb images">
                                                <img class="img-sm" src="{{asset('build/assets/img/ecommerce/05.jpg')}}"
                                                    alt="thumb images">
                                            </div>
                                        </li>
                                        <li class="list-item">
                                            <img class="img-sm rounded-circle bg-warning d-flex align-items-center justify-content-center text-white"
                                                src="{{asset('build/assets/img/users/5.jpg')}}" alt="Profile Image">
                                            <div class=" ms-3">
                                                <h6 class="mb-1 fw-medium">Bruce Tran</h6>
                                                <p class="mb-0 text-muted tx-13">#PRD-10252</p>
                                            </div>
                                            <div class="ms-auto d-flex">
                                                <img class="img-sm me-1" src="{{asset('build/assets/img/ecommerce/06.jpg')}}"
                                                    alt="thumb images">
                                                <img class="img-sm" src="{{asset('build/assets/img/ecommerce/07.jpg')}}"
                                                    alt="thumb images">
                                            </div>
                                        </li>
                                        <li class="list-item">
                                            <img class="img-sm rounded-circle bg-warning d-flex align-items-center justify-content-center text-white"
                                                src="{{asset('build/assets/img/users/12.jpg')}}" alt="Profile Image">
                                            <div class=" ms-3">
                                                <h6 class="mb-1 fw-medium">Mina Harper</h6>
                                                <p class="mb-0 text-muted tx-13">#PRD-10253</p>
                                            </div>
                                            <div class="ms-auto d-flex">
                                                <img class="img-sm me-1" src="{{asset('build/assets/img/ecommerce/08.jpg')}}"
                                                    alt="thumb images">
                                                <img class="img-sm" src="{{asset('build/assets/img/ecommerce/09.jpg')}}"
                                                    alt="thumb images">
                                            </div>
                                        </li>
                                        <li class="list-item pb-0 mb-0">
                                            <img class="img-sm rounded-circle bg-warning d-flex align-items-center justify-content-center text-white"
                                                src="{{asset('build/assets/img/users/8.jpg')}}" alt="Profile Image">
                                            <div class=" ms-3">
                                                <h6 class="mb-1 fw-medium">Maria Quinn</h6>
                                                <p class="mb-0 text-muted tx-13">#PRD-10254</p>
                                            </div>
                                            <div class="ms-auto d-flex">
                                                <img class="img-sm me-1" src="{{asset('build/assets/img/ecommerce/02.jpg')}}"
                                                    alt="thumb images">
                                                <img class="img-sm" src="{{asset('build/assets/img/ecommerce/01.jpg')}}"
                                                    alt="thumb images">
                                            </div>
                                        </li>
                                    </ul>
                        ...
                        <div class="col-lg-6 col-xl-4 col-md-12 col-sm-12">
                            <div class="card overflow-hidden latest-tasks">
                                <div class="">
                                    <div class="card-header p-0 d-flex justify-content-between px-4 pt-4 ">
                        ...
                        <div class="col-md-12 col-lg-6 col-xl-4 col-sm-12">
                            <div class="card">
                                ...
                                <p class="tx-12 tx-gray-500 mb-0 px-3">A review is an evaluation of a publication,
                                    service, or company .<a href="javascript:void(0);">Learn more</a></p>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="tx-12 tx-gray-500 mb-0">Tells you where your visitors originated from, such as
                                        search engines, social networks or website referrals. <a href="javascript:void(0);">Learn more</a></p>
                                </div><!-- card-header -->
                                <div class="card-body p-0">
                                    <div class="browser-stats">
                                        <div class="d-flex align-items-center item  border-bottom">
                                            <div class="d-flex">
                                                <img src="{{asset('build/assets/img/svgicons/chrome.svg')}}" alt="img"
                                        ...
                                        <div class="d-flex align-items-center item  border-bottom">
                                            <div class="d-flex">
                                                <img src="{{asset('build/assets/img/svgicons/opera.svg')}}" alt="img"
                                                    class="ht-30 wd-30 me-2">
                                                <div class="">
                                                    <h6 class="">Opera</h6>
                                                    <span class="sub-text">Mozilla Foundation, Inc.</span>
                                        ...
                                        <div class="d-flex align-items-center item  border-bottom">
                                            <div class="d-flex">
                                                <img src="{{asset('build/assets/img/svgicons/edge.svg')}}" alt="img"
                                                    class="ht-30 wd-30 me-2">
                                                <div class="">
                                                    <h6 class="">Edge</h6>
                                                    <span class="sub-text">Mozilla Foundation, Inc.</span>
                                        ...
                                        <div class="d-flex align-items-center item  border-bottom">
                                            <div class="d-flex">
                                                <img src="{{asset('build/assets/img/svgicons/firefox.svg')}}" alt="img"
                                                    class="ht-30 wd-30 me-2">
                                                <div class="">
                                                    <h6 class="">Firefox</h6>
                                                    <span class="sub-text">Mozilla Foundation, Inc.</span>
                                        ...
                                        <div class="d-flex align-items-center item border-bottom">
                                            <div class="d-flex">
                                                <img src="{{asset('build/assets/img/svgicons/uc-browser.svg')}}" alt="img"
                                                    class="ht-30 wd-30 me-2">
                                                <div class="">
                                        ...
                                        <div class="d-flex align-items-center item">
                                            <div class="d-flex">
                                                <img src="{{asset('build/assets/img/svgicons/safari.svg')}}" alt="img"
                                                    class="ht-30 wd-30 me-2">
                                                <div class="">
                                                    <h6 class="">Safari</h6>
                                                    <span class="sub-text">Mozilla Foundation, Inc.</span>
