						...
						<div class="col-lg-12 col-md-12">
							<div class="card">
								<div class="card-body">
									...
									<div class="pd-30 pd-sm-40 background">
						...
						<div class="col-lg-12 col-md-12">
							<div class="card">
								<div class="card-body">
									...
									<p class="mg-b-20">It is Very Easy to Customize and it uses in your website apllication.</p>
									<div class="tx-center pd-y-20 background">
										<a class="btn btn-main-primary" data-bs-target="#modaldemo1" data-bs-toggle="modal" href="javascript:void(0);">View Live Demo</a>
									</div><!-- pd-y-30 -->
									<div class="modal">
											...
											<div class="modal-content">
												<div class="modal-body pd-sm-40">
													...
													<div class="form-group mg-b-25">
														<label class="ckbox mg-b-5"><input type="checkbox"><span class="tx-13">I agree to <a href="javascript:void(0);">Terms</a> and <a href="javascript:void(0);">Privacy Policy</a></span></label> <label class="ckbox"><input checked type="checkbox"><span class="tx-13">Yes, I want to receive email from your newsletter.</span></label>
											...
											<div class="card card-body pd-20 pd-md-40 border shadow-none">
												...
												<div class="form-group">
													...
													<div class="pos-relative">
														...
														<div class="d-flex pos-absolute t-5 r-10"><img alt="" class="wd-30 mg-r-5" src="{{asset('build/assets/img/pngs/13.png')}}"> <img alt="" class="wd-30" src="{{asset('build/assets/img/pngs/12.png')}}"></div>
													</div>
												</div>
												<div class="form-group">
