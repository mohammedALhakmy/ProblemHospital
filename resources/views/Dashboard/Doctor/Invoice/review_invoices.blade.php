                                        ...
                                        <table class="table text-md-nowrap" id="example1">
                                           ...
                                           @foreach($invoices as $invoice)
                                               <tr>
                                                   ...
                                                   <td>
                                                       <a href="{{route('Invoice.show',$invoice->patient_id)}}">{{ $invoice->Patient->name }}</a>
                                                   </td>
                                                   ...
                                                   <div class="btn-group ms-2 mt-2 mb-2">
                                                        <div class="dropdown">
                                                           ...
                                                           <div class="dropdown-menu tx-13">
                                                               <a class="modal-effect" data-effect="effect-scale" data-bs-toggle="modal"
                                               data-bs-placement="top"  data-bs-effect="effect-super-scaled"  data-toggle="modal" href="#add_diagnosis{{$invoice->id}}"><i class="text-primary fa fa-stethoscope">
                                                                   </i>&nbsp;&nbsp;اضافة تشخيص </a>
