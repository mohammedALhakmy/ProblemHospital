                                        ...
                                        <div class="list-group list-lg-group list-group-flush">
                                            <div class="list-group-item list-group-item-action">
                                                <div class="media mt-0">
                                                    <img class="avatar-lg rounded-circle my-auto me-3" src="{{asset('build/assets/img/users/3.jpg')}}" alt="Image description">
                                            ...
                                            <div class="list-group-item list-group-item-action br-t-1">
                                                <div class="media mt-0">
                                                    <img class="avatar-lg rounded-circle my-auto me-3" src="{{asset('build/assets/img/users/11.jpg')}}" alt="Image description">
                                                    <div class="media-body">
                                                        <div class="d-flex align-items-center">
                                                            <div class="mt-1">
                                            ...
                                            <div class="list-group-item list-group-item-action br-t-1">
                                                <div class="media mt-0">
                                                    <img class="avatar-lg rounded-circle my-auto me-3" src="{{asset('build/assets/img/users/17.jpg')}}" alt="Image description">
                                                    <div class="media-body">
                                                        <div class="d-flex align-items-center">
                                                            <div class="mt-1">
                                            ...
                                            <div class="list-group-item list-group-item-action br-t-1">
                                                <div class="media mt-0">
                                                    <img class="avatar-lg rounded-circle my-auto me-3" src="{{asset('build/assets/img/users/15.jpg')}}" alt="Image description">
                                                    <div class="media-body">
                                                        <div class="d-flex align-items-center">
                                                            <div class="mt-1">
                                            ...
                                            <div class="list-group-item list-group-item-action br-t-1 br-be-7 br-bs-7">
                                                <div class="media mt-0">
                                                    <img class="avatar-lg rounded-circle my-auto me-3" src="{{asset('build/assets/img/users/6.jpg')}}" alt="Image description">
                                                    <div class="media-body">
                                                        <div class="d-flex align-items-center">
                                                            <div class="mt-1">
