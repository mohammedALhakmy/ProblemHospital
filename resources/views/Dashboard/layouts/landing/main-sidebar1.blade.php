                            ...
                            <div class="row">
                                <div class="main-sidemenu navbar px-0">
                                    <a class="main-logo" href="{{url('index')}}">
                                        <img src="{{asset('build/assets/img/brand/logo-white.png')}}" class="header-brand-img desktop-logo"
                                            alt="logo">
                                    ...
                                    <ul class="side-menu">
                                        ...
                                        <li class="slide">
                                            <a class="side-menu__item" data-bs-toggle="slide" href="#sectionfaq"><span
                                    ...
                                    <div class="header-nav-right d-none d-lg-block">
                                        <a href="{{url('signin')}}" class="btn ripple btn-min w-sm btn-outline-info me-2"
                                            target="_blank">New User
                                        </a>
                                        <a href="{{url('signin')}}" class="btn ripple btn-min w-sm btn-primary me-2"
                                            target="_blank">Login
                                        </a>
                                    </div>
                    ...
                    <div class="container px-sm-0">
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-lg-6 my-auto">
                                <img src="{{asset('build/assets/img/pngs/14.png')}}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
