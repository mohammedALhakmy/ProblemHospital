														...
														<ul class="sidemenu-list">
															...
															<li class="sub-slide">
																...
																<ul class="sub-slide-menu">
																	<li><a class="sub-side-menu__item" href="{{url('filemanager')}}">Filemanager</a></li>
																	<li><a class="sub-side-menu__item" href="{{url('filemanager-list')}}">Filemanager-List</a></li>
																	<li><a class="sub-side-menu__item" href="{{url('filemanager-details')}}">Filemanager-Details</a></li>
																	<li><a class="sub-side-menu__item" href="{{url('file-attachments')}}">File-Attachments</a></li>
																</ul>
															</li>
														</ul>
													</div>
												...
												<div class="tab-content">
													<div class="tab-pane tab-content-show active" id="side20">
														<ul class="sidemenu-list">
															...
															<li><a class="slide-item" href="{{url('scrollspy')}}">Scrollspy</a></li>
														</ul>
													</div>
														...
														<ul class="sidemenu-list">
															...
															<li class="sub-slide">
																...
																<ul class="sub-slide-menu">
																	...
																	<li><a class="sub-side-menu__item" href="{{url('blog-details')}}">Blog-Details</a></li>
