				...
				<div class="sticky">
					<aside class="app-sidebar sidebar-scroll">
						<div class="main-sidebar-header active">
							<a class="desktop-logo logo-light active" href="{{url('index')}}"><img src="{{asset('build/assets/img/brand/logo.png')}}" class="main-logo" alt="logo"></a>
							<a class="desktop-logo logo-dark active" href="{{url('index')}}"><img src="{{asset('build/assets/img/brand/logo-white.png')}}" class="main-logo" alt="logo"></a>
							<a class="logo-icon mobile-logo icon-light active" href="{{url('index')}}"><img src="{{asset('build/assets/img/brand/favicon.png')}}" alt="logo"></a>
							<a class="logo-icon mobile-logo icon-dark active" href="{{url('index')}}"><img src="{{asset('build/assets/img/brand/favicon-white.png')}}" alt="logo"></a>
						</div>
						<div class="main-sidemenu">
							<div class="app-sidebar__user clearfix">
								<div class="dropdown user-pro-body">
									<div class="main-img-user avatar-xl">
										<img alt="user-img" src="{{asset('build/assets/img/users/6.jpg')}}"><span class="avatar-status profile-status bg-green"></span>
									</div>
									<div class="user-info">
...
<path d="M12 4c-4.42 0-8 3.58-8 8s3.58 8 8 8 8-3.58 8-8-3.58-8-8-8zm3.5 4c.83 0 1.5.67 1.5 1.5s-.67 1.5-1.5 1.5-1.5-.67-1.5-1.5.67-1.5 1.5-1.5zm-7 0c.83 0 1.5.67 1.5 1.5S9.33 11 8.5 11 7 10.33 7 9.5 7.67 8 8.5 8zm3.5 9.5c-2.33 0-4.32-1.45-5.12-3.5h1.67c.7 1.19 1.97 2 3.45 2s2.76-.81 3.45-2h1.67c-.8 2.05-2.79 3.5-5.12 3.5z" opacity=".3"/>
                                            ...
                                            <path d="M12 16c-1.48 0-2.75-.81-3.45-2H6.88c.8 2.05 2.79 3.5 5.12 3.5s4.32-1.45 5.12-3.5h-1.67c-.69 1.19-1.97 2-3.45 2zm-.01-14C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"/></svg><span class="side-menu__label">Section</span><i class="angle fe fe-chevron-down"></i></a>
									<ul class="slide-menu">
												...
												<div class="tab-content">
													<div class="tab-pane tab-content-show active" id="side11">
														<ul class="sidemenu-list">
															<li class="side-menu__label1"><a href="javascript:void(0);">{{trans('message.Section')}}</a></li>
															<li><a class="slide-item" href="{{route('Section.index')}}">{{__('message.Section')}}</a></li>
															<li><a class="slide-item" href="{{route('Doctor.index')}}">{{__('message.Doctor')}}</a></li>
															<li><a class="slide-item" href="{{route('Service.index')}}">{{__('message.Service')}}</a></li>
															<li><a class="slide-item" href="{{route('Add_GroupService')}}">مجموعة خدمات</a></li>
															...
															<li><a class="slide-item" href="{{route('Patient.index')}}">Patient</a></li>
															<li><a class="slide-item" href="{{route('single_invoices')}}">single_invoices</a></li>
                                                            <li><a class="slide-item" href="{{route('ReceiptAccount.index')}}">ReceiptAccount</a></li>
                                                               <li><a class="slide-item" href="{{route('Payment.index')}}">Payment</a></li>
                                                              <li><a class="slide-item" href="{{route('GroupInvoice')}}">GroupInvoice</a></li>
														<li><a class="slide-item" href="{{route('laboratorie_employee.index')}}">المختبر  </a></li>
													...
													<div class="tab-pane tab-content-double" id="side13">
														...
														<div class="activity mt-3 p-0">
															<img src="{{asset('build/assets/img/users/8.jpg')}}" alt="" class="img-activity">
															...
															<img src="{{asset('build/assets/img/users/5.jpg')}}" alt="" class="img-activity">
															<div class="time-activity">
																<div class="item-activity">
															...
															<img src="{{asset('build/assets/img/users/6.jpg')}}" alt="" class="img-activity">
															<div class="time-activity">
																<div class="item-activity">
															...
															<img src="{{asset('build/assets/img/users/7.jpg')}}" alt="" class="img-activity">
															<div class="time-activity">
																<div class="item-activity">
															...
															<img src="{{asset('build/assets/img/users/14.jpg')}}" alt="" class="img-activity">
															<div class="time-activity">
																<div class="item-activity">
															...
															<img src="{{asset('build/assets/img/users/3.jpg')}}" alt="" class="img-activity">
															<div class="time-activity">
																<div class="item-activity">
															...
															<img src="{{asset('build/assets/img/users/1.jpg')}}" alt="" class="img-activity">
															<div class="time-activity">
																<div class="item-activity">
															...
															<img src="{{asset('build/assets/img/users/11.jpg')}}" alt="" class="img-activity">
															<div class="time-activity">
																<div class="item-activity">
                                ...
                                <li class="side-item side-item-category">الكشوفات</li>
								<li class="slide">
									<a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon"  viewBox="0 0 24 24">
                                            <path d="M0 0h24v24H0V0z" fill="none"/>
<path d="M12 4c-4.42 0-8 3.58-8 8s3.58 8 8 8 8-3.58 8-8-3.58-8-8-8zm3.5 4c.83 0 1.5.67 1.5 1.5s-.67 1.5-1.5 1.5-1.5-.67-1.5-1.5.67-1.5 1.5-1.5zm-7 0c.83 0 1.5.67 1.5 1.5S9.33 11 8.5 11 7 10.33 7 9.5 7.67 8 8.5 8zm3.5 9.5c-2.33 0-4.32-1.45-5.12-3.5h1.67c.7 1.19 1.97 2 3.45 2s2.76-.81 3.45-2h1.67c-.8 2.05-2.79 3.5-5.12 3.5z" opacity=".3"/>
                                            <circle cx="15.5" cy="9.5" r="1.5"/>
                                            <circle cx="8.5" cy="9.5" r="1.5"/>
                                            <path d="M12 16c-1.48 0-2.75-.81-3.45-2H6.88c.8 2.05 2.79 3.5 5.12 3.5s4.32-1.45 5.12-3.5h-1.67c-.69 1.19-1.97 2-3.45 2zm-.01-14C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"/></svg>
										...
										<li class="panel sidetab-menu">
											...
											<div class="panel-body tabs-menu-body p-0 border-0">
												<div class="tab-content">
													<div class="tab-pane tab-content-show active" id="side11">
														<ul class="sidemenu-list">
															<li class="side-menu__label1"><a href="javascript:void(0);">{{trans('message.الكشوفات')}}</a></li>
															<li><a class="slide-item" href="{{route('Invoice.index')}}">{{__('message.الكشوفات')}}</a></li>
															<li><a class="slide-item" href="{{route('completedInvoices')}}">{{__('message.completedInvoices')}}</a></li>
															<li><a class="slide-item" href="{{route('reviewInvoices')}}">{{__('message.reviewInvoices')}}</a></li>
{{--															<li><a class="slide-item" href="{{route('laboratorie_employee')}}">المختبر  </a></li>--}}
{{--															<li><a class="slide-item" href="{{route('Insurance.index')}}">Insurance</a></li>--}}
{{--															<li><a class="slide-item" href="{{route('Ambulance.index')}}">Ambulance</a></li>--}}
{{--															<li><a class="slide-item" href="{{route('Patient.index')}}">Patient</a></li>/--}}
{{--															<li><a class="slide-item" href="{{route('single_invoices')}}">single_invoices</a></li>--}}
...
{{--                                                              <li><a class="slide-item" href="{{route('GroupInvoice')}}">GroupInvoice</a></li>--}}
												...
												<div class="tab-content">
													<div class="tab-pane tab-content-show active" id="side14">
														<ul class="sidemenu-list">
															...
															<li><a class="slide-item" href="{{route('invoices_ray_employee.index')}}">الاشعة</a></li>
															<li><a class="slide-item" href="{{route('invoices_ray_employee.create')}}">الاشعة المكتملة</a></li>
                                                            <li><a class="slide-item" href="{{route('invoices_ray_employee.create')}}">الاشعة المكتملة</a></li>
														</ul>
													</div>
												...
												<div class="tab-content">
													<div class="tab-pane tab-content-show active" id="side17">
														<ul class="sidemenu-list">
															...
															<li><a class="slide-item" href="{{route('labs.index')}}">labs</a></li>
														</ul>
													</div>
												</div>
											</div>
                                ...
                                @if(auth('patient'))
								<li class="side-item side-item-category">المريض</li>
								<li class="slide">
									<a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M4 12c0 4.08 3.06 7.44 7 7.93V4.07C7.05 4.56 4 7.92 4 12z" opacity=".3"/><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 17.93c-3.94-.49-7-3.85-7-7.93s3.05-7.44 7-7.93v15.86zm2-15.86c1.03.13 2 .45 2.87.93H13v-.93zM13 7h5.24c.25.31.48.65.68 1H13V7zm0 3h6.74c.08.33.15.66.19 1H13v-1zm0 9.93V19h2.87c-.87.48-1.84.8-2.87.93zM18.24 17H13v-1h5.92c-.2.35-.43.69-.68 1zm1.5-3H13v-1h6.93c-.04.34-.11.67-.19 1z"/></svg><span class="side-menu__label">Apps</span><i class="angle fe fe-chevron-down"></i></a>
									<ul class="slide-menu">
										<li class="panel sidetab-menu">
                            ...
                            <li><a class="slide-item" href="{{route('rays.patient')}}">الاشعة</a></li>
												...
												<div class="tab-content">
													<div class="tab-pane tab-content-show active" id="side29">
														<ul class="sidemenu-list">
															...
															<li><a class="slide-item" href="{{url('form-sizes')}}">Form-Sizes</a></li>
														</ul>
													</div>
												...
												<div class="tab-content">
													<div class="tab-pane tab-content-show active" id="side32">
														<ul class="sidemenu-list">
															...
															<li><a class="slide-item" href="{{url('edit-table')}}">Edit Tables</a></li>
														</ul>
													</div>
								...
								<li class="slide">
									<a class="side-menu__item" href="{{url('landing-page')}}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0z" fill="none"/><path d="M12 4.02C7.6 4.02 4.02 7.6 4.02 12S7.6 19.98 12 19.98s7.98-3.58 7.98-7.98S16.4 4.02 12 4.02zM11.39 19v-5.5H8.25l4.5-8.5v5.5h3L11.39 19z" opacity=".3"/><path d="M12 2.02c-5.51 0-9.98 4.47-9.98 9.98s4.47 9.98 9.98 9.98 9.98-4.47 9.98-9.98S17.51 2.02 12 2.02zm0 17.96c-4.4 0-7.98-3.58-7.98-7.98S7.6 4.02 12 4.02 19.98 7.6 19.98 12 16.4 19.98 12 19.98zM12.75 5l-4.5 8.5h3.14V19l4.36-8.5h-3V5z"/></svg><span class="side-menu__label">Landing Page</span></a>
								</li>
								<li class="slide">
												...
												<div class="tab-content">
													<div class="tab-pane tab-content-show active" id="side38">
														<ul class="sidemenu-list">
															...
															<li><a class="slide-item" href="{{url('edit-profile')}}">Edit-Profile</a></li>
															<li><a class="slide-item" href="{{url('about')}}">About-Us</a></li>
															...
															<li><a class="slide-item" href="{{url('empty-page')}}">Empty Page</a></li>
															<li><a class="slide-item" href="{{url('switcher-page')}}">Switcher</a></li>
															<li class="sub-slide">
															...
															<li class="sub-slide">
																...
																<ul class="sub-slide-menu">
																	<li><a class="sub-side-menu__item" href="{{url('products')}}">Shop</a></li>
