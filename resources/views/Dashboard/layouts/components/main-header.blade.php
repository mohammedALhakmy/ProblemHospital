											...
											<div class="dropdown  nav-item countries">
												...
												<div class="dropdown-menu dropdown-menu-start  dropdown-menu-arrow">
													<a href="javascript:void(0);" class="dropdown-item d-flex ">
														<span class="avatar me-1 align-self-center bg-transparent"><img src="{{asset('build/assets/img/flag-imgs/french_flag.jpg')}}" alt="img"></span>
														<div class="d-flex">
															<span class="mt-2">French</span>
														</div>
													</a>
													<a href="javascript:void(0);" class="dropdown-item d-flex">
														<span class="avatar me-1 align-self-center bg-transparent"><img src="{{asset('build/assets/img/flag-imgs/germany_flag.jpg')}}" alt="img"></span>
														<div class="d-flex">
															<span class="mt-2">Germany</span>
														</div>
													</a>
													<a href="javascript:void(0);" class="dropdown-item d-flex">
														<span class="avatar me-1 align-self-center bg-transparent"><img src="{{asset('build/assets/img/flag-imgs/italy_flag.jpg')}}" alt="img"></span>
														<div class="d-flex">
															<span class="mt-2">Italy</span>
														</div>
													</a>
													<a href="javascript:void(0);" class="dropdown-item d-flex">
														<span class="avatar me-1 align-self-center bg-transparent"><img src="{{asset('build/assets/img/flag-imgs/russia_flag.jpg')}}" alt="img"></span>
														<div class="d-flex">
															<span class="mt-2">Russia</span>
														</div>
													</a>
													<a href="javascript:void(0);" class="dropdown-item d-flex">
														<span class="avatar me-1 align-self-center bg-transparent"><img src="{{asset('build/assets/img/flag-imgs/spain_flag.jpg')}}" alt="img"></span>
														<div class="d-flex">
											...
											<div class="dropdown-menu">
												...
												<div class="main-notification-list Notification-scroll">
													<div class="d-flex p-3 border-bottom">
														...
														<div class="ms-3">
															<a href="{{url('mail')}}"><h5 class="notification-label mb-1">New files available</h5></a>
