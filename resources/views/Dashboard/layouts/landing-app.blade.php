...
<html lang="en" dir="ltr">
	...
	<body class="main-body app sidebar-mini ltr landing-page horizontalmenu">
		...
		<div class="page">
            <div class="page-main">
                <!-- MAIN-HEADER -->
                @include('Dashboard.layouts.landing.main-header')
                <!-- END MAIN-HEADER -->

                <!-- MAIN-SIDEBAR -->
                @include('Dashboard.layouts.landing.main-sidebar')
                <!-- END MAIN-SIDEBAR -->
            ...
            <!-- FOOTER -->
            @include('Dashboard.layouts.landing.footer')
            <!-- END FOOTER -->
        ...
        @include('Dashboard.layouts.landing.scripts')
