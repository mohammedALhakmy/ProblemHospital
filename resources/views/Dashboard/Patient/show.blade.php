                                            ...
                                            <div class="panel panel-primary tabs-style-2">
                                              <div class=" tab-menu-heading">
                                                    ...
                                                    <ul class="nav panel-tabs main-nav-line">
                                                        ...
                                                        <li><a href="#tab1" class="nav-link active me-1"
                                                                    data-bs-toggle="tab">معلومات المريض</a></li>
                                            <li><a href="#tab2" class="nav-link   me-1"
                                                                    data-bs-toggle="tab">الفواتير</a>
                                            </li>
                                            <li><a href="#tab3" class="nav-link   me-1"
                                                                    data-bs-toggle="tab">المدفوعات</a>
                                            </li>
                                            <li><a href="#tab4" class="nav-link   me-1"
                                                                    data-bs-toggle="tab">كشف
                                                    حساب</a></li>
                                            <li><a href="#tab5" class="nav-link   me-1"
                                                                    data-bs-toggle="tab">الاشعه</a>
                                            </li>
                                            <li><a href="#tab6" class="nav-link   me-1"
                                                                    data-bs-toggle="tab">المختبر</a>
                                            </li>
                                        </ul>
                                                    </div>
                                                </div>
