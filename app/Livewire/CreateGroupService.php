...
class CreateGroupService extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.GroupService.create-group-service', [
            'groups'=> Group::all(),
            'subtotal' => $Total_after_discount = $total - ((is_numeric($this->value_discount) ? $this->value_discount : 0)),
    ...
    public function saveGroup()
    {
        ...
        if($this->updateMode){
            ...
            // قيمة الخصم
            $Groups->value_discount = $this->value_discount;
            // الاجمالي بعد الخصم
            $Groups->total_after_discount = $total - ((is_numeric($this->value_discount) ? $this->value_discount : 0));
            //  نسبة الضريبة
            $Groups->tax_rate = $this->taxes;
            // الاجمالي + الضريبة
            $Groups->total_tax_rate = $Groups->total_after_discount * (1 + (is_numeric($this->taxes) ? $this->taxes : 0) / 100);
            $Groups->save();
            // حفظ الترجمة
    ...
    public function edit($id)
    {
        ...
        $this->value_discount = intval($group->value_discount);
        $this->ServiceSaved = false;
