...
class GroupInvoice extends Component
{
    ...
    {
        return view('livewire.group-invoice.group-invoice', [
            'group_invoices'=>GroupInvoices::all(),
    ...
    public function get_price()
    {
        ...
        $this->discount_value = Group::where('id', $this->Group_id)->first()->value_discount;
    ...
    public function store()
    {
        ...
        if($this->type == 1){
            ...
            try {
                ...
                if($this->updateMode){
                    dd("SS");
                    $group_invoices = GroupInvoices::findorfail($this->group_invoice_id);
                ...
                // في حالة الاضافة
                    ...
                    $group_invoices = new GroupInvoices();
...
//                    $group_invoices->type = $this->type;
                    $group_invoices->save();
                    $patient_accounts = PatientAccount::where('single_invoice_id',$this->group_invoice_id)->first();
                    $patient_accounts->date =  date('Y-m-d');
                    $patient_accounts->single_invoice_id = $group_invoices->id;
...
//                    $group_invoices->type = $this->type;
    ...
    public function edit($id){
        ...
        $group_invoices = GroupInvoices::findorfail($id);
    ...
    public function destroy(){
        GroupInvoices::destroy($this->group_invoice_id);
    ...
    {
        $single_invoice = GroupInvoices::findorfail($id);
